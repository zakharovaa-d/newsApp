package com.zd.mynewsapp.news_feed
...
import com.zd.mynewsapp.adapter.ArticleAdapter
import com.zd.mynewsapp.model.Article
import com.zd.mynewsapp.model.TopHeadlines
import com.zd.mynewsapp.news_api.TopHeadlinesEndpoint
    ...
    private fun createArticleObserver(): DisposableObserver<Article> {
        return object : DisposableObserver<Article>() {
            ...
            override fun onError(e: Throwable) {
                Log.e("zakharova","createArticleObserver(), Article error: ${e.message}")
            }
        }
    }
